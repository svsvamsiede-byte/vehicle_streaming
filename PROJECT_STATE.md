...
|---------|-----------|-----------|------|--------|--------------|----------------|------------|--------|-------|
| M1-E1-T01 | Create `.env` Environment File | M1 | M1-E1 | NOT_STARTED | None | `.env` | - | main | — |
| M1-E1-T02 | Create `docker-compose.yml` Base Services | M1 | M1-E1 | NOT_STARTED | M1-E1-T01 | `docker-compose.yml` | - | main | — |
...
| M1-E2-T01 | Configure Zookeeper Service | M1 | M1-E2 | NOT_STARTED | M1-E1-T02 | `docker-compose.yml` (edited) | - | main | — |
...
| M1-E3-T01 | Configure MinIO Service | M1 | M1-E3 | NOT_STARTED | M1-E1-T02 | `docker-compose.yml` (edited) | - | main | — |
...
| M1-E4-T01 | Configure PyFlink JobManager Service | M1 | M1-E4 | NOT_STARTED | M1-E1-T02 | `docker-compose.yml` (edited) | - | main | — |
...
| M1-E5-T01 | Configure Prometheus Service | M1 | M1-E5 | NOT_STARTED | M1-E1-T02 | `docker-compose.yml` (edited) | - | main | — |
...
| M2-E1-T01 | Create Simulator Configuration Module | M2 | M2-E1 | NOT_STARTED | M1-E2-T02 | `producer/config.py` | - | main | — |
| M2-E1-T02 | Create Vehicle Data Models | M2 | M2-E1 | NOT_STARTED | M2-E1-T01 | `producer/schemas.py` | - | main | — |
...
| M2-E2-T01 | Implement Topic Creation Script | M2 | M2-E2 | NOT_STARTED | M1-E2-T04 | `scripts/create_topics.py` (edited) | - | main | — |
...
| M2-E3-T01 | Add Simulator to Docker Compose | M2 | M2-E3 | NOT_STARTED | M2-E1-T06, M2-E2-T01 | `docker-compose.yml` (edited) | - | main | — |
| M2-E3-T02 | Add Health Check Endpoint | M2 | M2-E3 | NOT_STARTED | M2-E3-T01 | `docker-compose.yml` (edited) | - | main | — |
| M3-E1-T01 | Create Flink Job Entry Point | M3 | M3-E1 | NOT_STARTED | M1-E4-T04 | `flink/main.py` | - | main | — |
| M3-E1-T02 | Create Flink Requirements File | M3 | M3-E1 | NOT_STARTED | M1-E4-T04 | `flink/requirements.txt` | - | main | — |
...
| M3-E2-T01 | Create Timestamp Assigner | M3 | M3-E2 | NOT_STARTED | M3-E1-T03 | `flink/timestamps.py` | - | main | — |
...
| M3-E3-T01 | Create Validation Rules Engine | M3 | M3-E3 | NOT_STARTED | M3-E1-T03 | `flink/validation.py` | - | main | — |
...
| M4-E1-T01 | Create Tumbling Window Processor | M4 | M4-E1 | NOT_STARTED | M3-E2-T03 | `flink/windows.py` | - | main | — |
| M4-E1-T02 | Create Sliding Window Processor | M4 | M4-E1 | NOT_STARTED | M4-E1-T01 | `flink/windows.py` (edited) | - | main | — |
...
| M4-E2-T01 | Create State Backend Configuration | M4 | M4-E2 | NOT_STARTED | M1-E4-T03 | `flink/conf/flink-conf.yaml` (edited) | - | main | — |
...
| M4-E3-T01 | Create Alert Rules Configuration | M4 | M4-E3 | NOT_STARTED | M3-E3-T01 | `flink/alerts.py` | - | main | — |
...
| M5-E1-T01 | Create Iceberg Table Definitions | M5 | M5-E1 | NOT_STARTED | M1-E3-T04 | `iceberg/sql/create_tables.sql` | - | main | — |
| M5-E1-T02 | Create Flink Iceberg Sink Configuration | M5 | M5-E1 | NOT_STARTED | M5-E1-T01, M1-E4-T04 | `flink/iceberg_sink.py` | - | main | — |
...
| M5-E2-T01 | Configure Flink Checkpointing | M5 | M5-E2 | NOT_STARTED | M3-E1-T01 | `flink/conf/flink-conf.yaml` (edited), `flink/main.py` (edited) | - | main | — |
...
| M5-E3-T01 | Create Schema Evolution Script | M5 | M5-E3 | NOT_STARTED | M5-E1-T01 | `iceberg/sql/schema_evolution.sql` | - | main | — |
...
| M6-E1-T01 | Configure Trino Service | M6 | M6-E1 | NOT_STARTED | M1-E3-T02 | `docker-compose.yml` (edited) | - | main | — |
| M6-E1-T02 | Create Trino Iceberg Catalog Configuration | M6 | M6-E1 | NOT_STARTED | M6-E1-T01 | `trino/catalog/iceberg.properties` | - | main | — |
...
| M6-E2-T01 | Create Pipeline Metrics Dashboard | M6 | M6-E2 | NOT_STARTED | M1-E5-T04 | `grafana/dashboards/pipeline_metrics.json` | - | main | — |
...
| M6-E3-T01 | Configure Flink Metrics Reporter | M6 | M6-E3 | NOT_STARTED | M1-E5-T02 | `flink/conf/flink-conf.yaml` (edited) | - | main | — |
...
| M7-E1-T01 | Configure Incremental Checkpoints | M7 | M7-E1 | NOT_STARTED | M5-E2-T01 | `flink/conf/flink-conf.yaml` (edited) | - | main | — |
| M7-E1-T02 | Create Savepoint Management Script | M7 | M7-E1 | NOT_STARTED | M7-E1-T01 | `scripts/savepoint_manager.py` | - | main | — |
| M7-E1-T03 | Configure State TTL | M7 | M7-E1 | NOT_STARTED | M4-E2-T04 | `flink/state.py` (edited) | - | main | — |
| M7-E2-T01 | Create Chaos Test Script | M7 | M7-E2 | NOT_STARTED | M7-E1-T02 | `tests/chaos/test_recovery.py` | - | main | — |
...
| M7-E3-T01 | Create Simulator Unit Tests | M7 | M7-E3 | NOT_STARTED | M2-E1-T06 | `tests/unit/test_simulator.py` | - | main | — |
...
| M8-E1-T01 | Document Vehicle Routes Feature | M8 | M8-E1 | NOT_STARTED | None | `docs/rfc/vehicle_routes.md` | - | main | — |
| M8-E1-T02 | Document REST API Feature | M8 | M8-E1 | NOT_STARTED | None | `docs/rfc/rest_api.md` | - | main | — |
...
| M8-E2-T01 | Create Cloud Architecture Comparison | M8 | M8-E2 | NOT_STARTED | None | `docs/cloud_migration.md` | - | main | — |
